...
namespace PromotionEngine
{
    class Program
    {
        ...
        {
            Console.WriteLine("Promotion Engine Starts");
            Console.WriteLine("----------****-----------");
        }
    }
    public class PromotionCalculate
    {
        // Total sales price of the  invoice after applying the promotions.
        ...
        float applyPromotion(Promotion promotions, Dictionary<string, int> SalesInvoice)
        {
            ...
            {  // product combination promotion, considered for 2 products combination with AND operation
        ...
        {
            public List<Promotion> list_of_promotions = new List<Promotion>();
            public Promotions()
            {
